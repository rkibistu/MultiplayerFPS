...
public class WeaponFireEffects : WeaponComponent {
    ...
    public override void OnRender(WeaponContext context, ref WeaponDesires desires) {
        ...
        if (_fireParticle != null) {
            var fireParticle = Context.Instance.ObjectCache.Get(_fireParticle);
            Context.Instance.ObjectCache.ReturnDeferred(fireParticle, _fireParticleReturnTime);
        ...
        bool x = _fireAudioEffects.PlaySound(_fireSound, EForceBehaviour.ForceAny);
    ...
    // PRIVATE METHODS
    public Transform baseTransformTest;
    private void UpdateKickback(bool hasFired) {
        ...
        //var weaponTransform = baseTransformTest;
        //_kickbackInitialPosition = baseTransformTest.localPosition;
        //_kickbackInitialRotation = baseTransformTest.localRotation;
